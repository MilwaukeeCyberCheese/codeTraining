...
//constructor
    ...
    public double getXLeft() {
        return MathUtil.applyDeadband(controller.getLeftX(), 0.2);
    }
    ...
    public double getXRight() {
        return MathUtil.applyDeadband(controller.getRightX(), 0.2);
    }
    ...
    public double getYLeft() {
        return MathUtil.applyDeadband(controller.getLeftY(), 0.2);
    }
    ...
    public double getYRight() {
        return MathUtil.applyDeadband(controller.getRightY(), 0.2);
    }
